...
class Particle {
    constructor(effect, i){
        ...
        if (this.index % 50 === 0) this.radius = Math.floor(Math.random() * 20 +  50);
    ...
    draw(context, context2){
        ...
        context2.beginPath();
        context2.arc(this.x - this.radius * 0.2, this.y - this.radius * 0.2, this.radius * 0.5, 0, Math.PI * 2);
        context2.fill();

        context2.fillStyle = 'olive';
        context2.beginPath();
        context2.arc(this.x, this.y, this.radius * 0.7, 0, Math.PI * 2);
        context2.fill();
...
class Effect {
    ...
    handleParticles(context, context2){
        ...
        this.particles.forEach(particle => {
            particle.draw(context, context2);
            particle.update();
        });
    }
